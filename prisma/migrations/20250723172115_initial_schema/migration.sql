...
-- CreateIndex
CREATE UNIQUE INDEX "Profile_publicName_key" ON "Profile"("publicName");
...
-- CreateIndex
CREATE UNIQUE INDEX "FeaturedSlot_profileId_key" ON "FeaturedSlot"("profileId");
...
-- AddForeignKey
ALTER TABLE "FeaturedSlot" ADD CONSTRAINT "FeaturedSlot_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
